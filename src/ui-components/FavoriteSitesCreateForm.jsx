...
export default function FavoriteSitesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new FavoriteSites(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FavoriteSitesCreateForm")}
      {...rest}
    >
      <ArrayField
        lengthLimit={1}
